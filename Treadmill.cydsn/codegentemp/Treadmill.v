...
module CharLCD_v2_0_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("4a35e357-94a5-4865-8ea5-e545157f278e/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	wire [0:0] tmpOE__SpeakerPin_net;
	wire [0:0] tmpFB_0__SpeakerPin_net;
	wire [0:0] tmpIO_0__SpeakerPin_net;
	wire [0:0] tmpINTERRUPT_0__SpeakerPin_net;
	electrical [0:0] tmpSIOVREF__SpeakerPin_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("3dba336a-f6a5-43fb-aed3-de1e0b7bf362"),
		  ...
		  .width(1))
		SpeakerPin
		 (.oe(tmpOE__SpeakerPin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SpeakerPin_net[0:0]}),
		  .io({tmpIO_0__SpeakerPin_net[0:0]}),
		  .siovref(tmpSIOVREF__SpeakerPin_net),
		  .interrupt({tmpINTERRUPT_0__SpeakerPin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SpeakerPin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
