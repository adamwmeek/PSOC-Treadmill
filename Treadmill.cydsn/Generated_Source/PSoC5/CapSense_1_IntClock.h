...
#define CapSense_1_IntClock_SetDivider(clkDivider)         CapSense_1_IntClock_SetDividerRegister(clkDivider, 1u)
#define CapSense_1_IntClock_SetDividerValue(clkDivider)    CapSense_1_IntClock_SetDividerRegister((clkDivider) - 1u, 1u)
...
#define CapSense_1_IntClock_SetPhaseValue(clkPhase)        CapSense_1_IntClock_SetPhaseRegister((clkPhase) + 1u)
#endif /* defined(CapSense_1_IntClock__CFG3) */
